...
if (__name__ == "__main__"):
    pot1 = Potential(V0.sine_func, 0.0005, 4, label="Sinusoidal potential")
    pot2 = Potential(V0.const, 0.0005, 226, label="Constant potential")
    pot3 = Potential(V0.linear_func, 0.0005, 226, label="Linear potential")
    pot4 = Potential(V0.quadratic_func, 0.0005, 226, label="Quadratic potential")
    pot5 = Potential(V0.exp_func, 0.0005, 226, label="Exponential potential")
    pot6 = Potential(V0.heaviside, 0.0005, 226, label="Heaviside potential")
    pot7 = Potential(V0.quartic_func, 0.0005, 226, label="Quartic potential")
